...
public class SessionConsentRegistryTest {
    @Test public void consentIsSessionScopedAndOpaque() {
        ...
        String id=r.accept("in-memory-key"); assertTrue(id.startsWith("p_")); assertFalse(id.contains("in-memory-key")); assertTrue(r.participantSessionId("in-memory-key").startsWith("ps_"));
