...
required=('DATASET_LOCK','BLIND_EVAL_SPEC_FREEZE','MODEL_SELECTION','MODEL_FREEZE','BLIND_TEST_EVALUATION','BLIND_HOLDOUT_EVALUATION','CROSS_ABLATION','NO_ACTION_AUDIT','TEMPORAL_AUDIT','SLICE_ANALYSIS','BOUNDARY_ANALYSIS','CPU_BENCHMARK','CHECKPOINT_SYNC','CHECKPOINT_SHA_MATCH','RESUME_VALIDATED','DETERMINISTIC_INFERENCE','CPU_GPU_PARITY','JAVA_EXPORT','PYTHON_GOLDEN_PARITY','JAVA_GOLDEN_PARITY','PYTHON_TESTS','JAVA_REGRESSION','GIT_DIFF_CHECK')
